...
resource "google_secret_manager_secret" "daemon_user_password" {
  secret_id = "daemon-user-password"
...
resource "google_secret_manager_secret_iam_member" "cloud_run_secrets" {
  ...
  depends_on = [
    ...
    google_secret_manager_secret.daemon_user_email,
    google_secret_manager_secret.daemon_user_password,
  ]
}
...
# -----------------------------------------------------------------------------
# NOTE: WIF resources (identity pool, provider, service account, IAM bindings)
# are managed OUTSIDE of Terraform via GCP Console.
#
# The GitHub Actions SA needs these roles (grant via Console):
# - roles/run.admin
# - roles/artifactregistry.writer
# - roles/secretmanager.admin
# - roles/iam.serviceAccountUser
# - roles/iam.serviceAccountViewer
# - roles/storage.objectAdmin (on glyx-terraform-state bucket)
# -----------------------------------------------------------------------------
